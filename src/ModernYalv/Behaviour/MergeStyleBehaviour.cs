namespace ModernYalv.Behaviour
{
  using System;
  ...
  public class MergeStyleBehaviour
  {
                                             ...
                                             DependencyPropertyChangedEventArgs e)
    {
      ...
      try
      {
        ...
        {
          string sInfo = string.Format("newStyle: {0}", (newStyle != null ? newStyle.TargetType.FullName : "(null)"));
          sInfo += string.Format("DependencyObject d: {0}", (d != null ? d.ToString() : "(null)"));
