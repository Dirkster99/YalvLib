...
namespace YalvLib.ViewModel
{
    ...
    internal class LogFileLoader
    {
        ...
        internal LogAnalysisWorkspace CreateLogAnalysisWorkspace(List<string> paths)
        {
            ...
            {
                string message = string.Format(YalvLib.Strings.Resources.GlobalHelper_ParseLogFile_Error_Text, paths,
                                               exception.Message);
            ...
            if (this.loadResultEvent != null)
            {
                if (this.mAbortedWithErrors == false && this.mAbortedWithCancel == false)
                    ...
                    this.loadResultEvent(this, new ResultEvent("Processing was not succesfull", this.mAbortedWithErrors,
                                                               this.mAbortedWithCancel, this.mObjColl,
                                                               this.mInnerException));
            }
        }
